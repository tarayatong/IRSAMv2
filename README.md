...
python training.py --batch_size 8 --image_size 512 --lr 1e-2 --dataset IRSTD-1k --save_dir ./checkpoints/alpha_loss/IRSTD-1k --gpu 1 --log_dir logs/alpha_loss --config_path ./sam_spl/configs/spl_t.yaml
