    ...
    def train_one_epoch(self) -> float:
        ...
        for idx, batch in enumerate(self.train_loader):
            ...
            if return_dict is not None:
                ...
                inter_bce = self.loss_fn(return_dict["target_mask"].sigmoid(), batch_masks) + self.loss_fn(return_dict["clutter_mask"].sigmoid(), clutter_labels) + self.loss_fn(return_dict['corrected_mask'].sigmoid(), batch_masks)
